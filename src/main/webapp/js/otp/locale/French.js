...
otp.locale.French = {
    ...
    menu : {
        ...
        aboutText: "<p>XiBi est encore en développement... mais fonctionne parfaitement bien :)</p>"
   },
    ...
    tipWidget : 
    {
       startPoint : "Commencez par cliquer sur la carte pour définir votre point de départ.",
       endPoint : "Ensuite, cliquez sur la carte pour définir votre point d'arrivée.",
       modifyTrip : "Astuce: déplacez les points de départ ou d'arrivée au besoin." 
    },
    ...
    tripPlanner : {
        ...
        [
            ...
            ['BICYCLE', 'Velo seulement'],
            ['WALK,BICYCLE', 'Velo-partage (BIXI)'],
            ['TRANSIT,BICYCLE', 'Transports publics et vélo'],
            ['TRANSIT,WALK,BICYCLE', 'Transports publics et velo-partage']
        ],
